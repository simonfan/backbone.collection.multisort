...
console.log('Loading BackboneCollectionMultisort qUnit configurations.');

define(['text!amd-test-config.json','underscore'], function(testConfigString, undef) {

    console.log('Loading BackboneCollectionMultisort qUnit tests.');
    ...
    return require(tests, function() {
        console.log('Initializing BackboneCollectionMultisort qUnit tests.');
